...
compatibility: Requires a Twilio account and TWILIO_ACCOUNT_SID/TWILIO_AUTH_TOKEN for live API work.
allowed-tools: Bash
upstream:
  repository: https://github.com/sickn33/antigravity-awesome-skills
  skill_path: skills/twilio-communications
  install: npx skills add https://github.com/sickn33/antigravity-awesome-skills --skill twilio-communications
  ref: 76cbde3d7c52708dd39db5cdb615a8a4350cab3b
---
...
Key considerations:
- Phone numbers must be in E.164 format (+12025550123)
...
class TwilioSMS:
    ...
    def send_sms(
        ...
        if not self.validate_e164(to):
            return {
                "success": False,
                "error": "Phone number must be in E.164 format (+12025550123)"
            }
...
result = verify.send_verification("+14155550123", VerifyChannel.SMS)
if result["success"]:
    print("Code sent! Check your phone.")

# Step 2: User enters the code they received
code = "123456"  # From user input
check = verify.check_verification("+14155550123", code)
...
class TwilioWhatsApp:
    ...
    def __init__(self):
        ...
        # WhatsApp number format: whatsapp:+14155550123
...
async def send_campaign():
    ...
    messages = [
        {"to": "+14155550123", "body": "Hello!"},
        {"to": "+14155550124", "body": "Hello!"},
