...
```bash
npm install --prefix shared/skills/browserbase/cookie-sync
```
...
```bash
node shared/skills/browserbase/cookie-sync/scripts/cookie-sync.mjs
```
...
```bash
node shared/skills/browserbase/cookie-sync/scripts/cookie-sync.mjs --domains google.com,github.com
```
...
```bash
node shared/skills/browserbase/cookie-sync/scripts/cookie-sync.mjs --context ctx_abc123
```
...
```bash
node shared/skills/browserbase/cookie-sync/scripts/cookie-sync.mjs --stealth
```
...
```bash
node shared/skills/browserbase/cookie-sync/scripts/cookie-sync.mjs --proxy "San Francisco,CA,US"
```
...
```bash
node shared/skills/browserbase/cookie-sync/scripts/cookie-sync.mjs --domains github.com,google.com --stealth --proxy "San Francisco,CA,US"
```
...
node shared/skills/browserbase/cookie-sync/scripts/cookie-sync.mjs --domains x.com,twitter.com
