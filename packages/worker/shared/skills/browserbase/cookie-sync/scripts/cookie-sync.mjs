...
//
// Usage:
//   node shared/skills/browserbase/cookie-sync/scripts/cookie-sync.mjs                                        # sync all cookies into a new context
//   node shared/skills/browserbase/cookie-sync/scripts/cookie-sync.mjs --domains google.com,github.com        # only sync cookies for these domains
//   node shared/skills/browserbase/cookie-sync/scripts/cookie-sync.mjs --context ctx_abc123                   # refresh cookies in an existing context
//   node shared/skills/browserbase/cookie-sync/scripts/cookie-sync.mjs --stealth                              # enable advanced stealth mode
//   node shared/skills/browserbase/cookie-sync/scripts/cookie-sync.mjs --proxy "San Francisco,CA,US"          # use residential proxy with geolocation
//
