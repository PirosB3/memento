...
This skill runs many `browse` commands (snapshots, clicks, evals). If your host environment supports shell allowlists, add `browse` to them so repeated QA runs stay smooth:
...
node shared/skills/browserbase/cookie-sync/scripts/cookie-sync.mjs --domains your-app.com
