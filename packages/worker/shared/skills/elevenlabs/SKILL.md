---
name: elevenlabs
description: Build voice AI agents with ElevenLabs. Use when creating voice assistants, customer service bots, interactive voice characters, outbound-call agents, or any real-time voice conversation experience.
license: MIT
...
upstream:
  ...
  skill_path: agents
  install: npx skills add https://github.com/elevenlabs/skills --skill agents
  ref: df1e6029c2a30914b3d73a60f7f8a177ea5bab34
---
...
"prompt": {
    ...
    "built_in_tools": {
        "end_call": {},
        "transfer_to_number": {"transfers": [{"transfer_destination": {"type": "phone", "phone_number": "+12025550123"}, "condition": "User asks for human support"}]}
    }
}
```
...
curl -X POST "https://api.elevenlabs.io/v1/convai/twilio/outbound-call" \
  -H "xi-api-key: $ELEVENLABS_API_KEY" -H "Content-Type: application/json" \
  -d '{"agent_id": "your-agent-id", "agent_phone_number_id": "your-phone-number-id", "to_number": "+12025550123", "call_recording_enabled": true}'
```
